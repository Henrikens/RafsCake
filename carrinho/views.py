    ...
    if carrinho:
        if opcao_pagamento.OpcaoSelecionada == 0:
            email = EmailMessage(
                ...
                Equipe RafsCake
                """,
                'rafs420vl@gmail.com',  # Substitua pelo seu e-mail
                [user.email],
            )
...
def __genereateqrcode(value:float):
    ...
    qr.add_data('00020126580014br.gov.bcb.pix0136d19e0eb6-3f37-4264-8e75-5b8632162c84520400005303986540550.005802BR5916Eliezer Schwartz6006Brasil62290525202310162006Q0H41I0YWFI3J6304F197')
    qr.make(fit=True)
